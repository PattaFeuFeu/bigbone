...
This guide explains how we publish releases for BigBone.
The process is based on GitHub Actions and the Gradle build system.
This guide is mostly relevant for project maintainers.
